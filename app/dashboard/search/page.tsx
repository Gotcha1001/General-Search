  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-8 p-6 md:p-10">
      ...
      >
        ...
        <div className="flex flex-col gap-1 sm:w-56">
          <div className="relative">
            <MapPin className="text-white absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2" />
            <Input
              value={location}
              onChange={(e) => {
                setLocationTouched(true);
          ...
          <p className="text-white/80 text-xs px-1">
            {currentUser?.location
              ? "Clear this to search everywhere, or edit to search elsewhere."
              : 'One city, region, or "Anywhere" -- set a default in Settings.'}
          </p>
        ...
        <Button
          ...
          className="bg-white text-black hover:bg-black hover:text-white disabled:opacity-100 disabled:bg-white/70 disabled:text-black transition-colors"
        >
          {submitting ? "Starting..." : "Search"}
        </Button>
      </form>
